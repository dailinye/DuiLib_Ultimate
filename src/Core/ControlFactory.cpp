...
namespace DuiLib 
{
	CControlFactory::CControlFactory()
	{
		...
		INNER_REGISTER_DUICONTROL(CMenuItemUI);
		INNER_REGISTER_DUICONTROL(CContextMenuUI);
		...
		INNER_REGISTER_DUICONTROL(CTreeNodeElementUI);
		INNER_REGISTER_DUICONTROL(CTreeNodeBodyUI);
		...
		INNER_REGISTER_DUICONTROL(CNotifyIconUI);
	}
